...
var baseUserDataSchema = _zod.z.object({
    ...
    status: _zod.z.enum(_service.validStatuses),
...
var userIdSchema = _zod.z.string().length(21);
...
var updateUserParamsSchema = _zod.z.object({
    id: userIdSchema
});
...
var updateActiveSchema = _zod.z.object({
    id: userIdSchema
});
